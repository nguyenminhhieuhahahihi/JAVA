package accepted.player.ui.widget;
...
import accepted.player.ui.equalizer.EqualizerViewModel;
...
public class BandChartView extends View {
    ...
    private void initView(Context context, @Nullable AttributeSet attrs) {
        ...
        mHintText = getContext().getString(R.string.accepted_ui_band_chart_hint);
        ...
        lineWidth = res.getDimensionPixelOffset(R.dimen.accepted_ui_band_chart_default_line_width);
        hintTextSize = res.getDimensionPixelOffset(R.dimen.accepted_ui_band_chart_default_hint_text_size);
        hintTextColor = Color.parseColor("#FF7043");
        gridLineWidth = res.getDimensionPixelOffset(R.dimen.accepted_ui_band_chart_default_grid_line_width);
        gridLineColor = Color.parseColor("#E0E0E0");

        int dashLength = res.getDimensionPixelOffset(R.dimen.accepted_ui_band_chart_dash_length);
